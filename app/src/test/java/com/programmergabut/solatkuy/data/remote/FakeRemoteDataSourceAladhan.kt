...
class FakeRemoteDataSourceAladhan(private val qiblaApiService: QiblaApiService,
                                  private val calendarApiService: CalendarApiService): RemoteDataSourceAladhan {
    //Coroutine
